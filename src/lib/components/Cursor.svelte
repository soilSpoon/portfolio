...
<div
	data-cursor-wrap
	class="pointer-events-none fixed inset-0 z-[2000] mix-blend-difference select-none"
	aria-hidden="true"
>
	<div
		data-cursor=""
		class="absolute h-[2em] w-[2em] rounded-full bg-white/60 will-change-transform"
	></div>
</div>
