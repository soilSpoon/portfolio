		...
		<div class="grid-main is-hw">
			...
			<div class="eb-wrap is-sticky hw-left">
				...
				<div btn-reveal="" class="page-btn-w">
					<div class="o-hidden is-flex">
						<a reveal-target="" href="/our-work" class="btn-w">
							<div class="btn-inner">
								<div class="o-hidden">
			...
			<div class="grid-main hcs-grid-w hw-right">
				{#each projects as project}
					<a hover-anim="" href="/our-work/{project.slug}" class="hcs-item-w">
...
<style>
	...
	/* ─── 배경 이미지 URLs ─────────────────────────────────────────────────── */
	:global(.hcs-img-w.is-lando)   { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/68ece3e91ef2f1125c5b57eb_lando-cs-hero-img.jpg'); }
	:global(.hcs-img-w.is--vizcom) { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/6980c243418b458602403062_ob-cs-lead.jpg'); }
	:global(.hcs-img-w.is--aether) { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/688216a05de42d3adfe4bf47_aether1-awwwards-main.webp'); }
	:global(.hcs-img-w.is--bella)  { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/6734a0e12af1829d3c649f35_bella-cs-hero-img.webp'); }
	:global(.hcs-img-w.is--jasp)   { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/6863c2232943ccb7fa37b67e_jasp%202.webp'); background-size: cover; }
	:global(.hcs-img-w.is--slack)  { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/68b6edabe6aadf7c4b4218a7_overview.jpg'); }
	:global(.hcs-img-w.is--totem.is--aptos) { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/680b5774ed70ee2ddaa9d963_aptoslabs.png'); }
	:global(.hcs-img-w.is--wf)     { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/6523d7db7bde5cea960a5dca_webflow%20logo%20square.svg'); }
	:global(.hcs-img-w.is--dl)     { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/651d0f87d43cf1073e47ec97_cs-dl-hero.jpg'); }
	:global(.hcs-img-w.is--cmcc)   { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/651ee37db52db1b35c9463f0_cs-cmcc-follow-up-large-2.jpg'); background-position: 50%; }
	:global(.hcs-img-w.is--tos)    { background-image: url('https://cdn.prod.website-files.com/64cf4cc8c9b14fe4cb3c54b4/651ee3dfcff32289633127b1_cs-tos-follow-up-1.jpg'); background-position: 50%; }
	...
	.btn-txt { font-size: 0.8em; letter-spacing: 0.05em; }
	.btn-icon-w { opacity: 0.6; }
	.btn-bg-w { position: absolute; inset: 0; z-index: 0; }
	.btn-bg-fill {
		width: 0%;
		height: 100%;
	...
	.btn-w:hover .btn-bg-fill { width: 100%; }
</style>
